          ...
          <div className="header_right d-flex flex-row align-items-center justify-content-start ml-auto">
            ...
            <div className="header_search">
              <form action="#" id="header_search_form">
                ...
                <button className="header_search_button"><img src={imgSearch} alt="" /></button>
              </form>
            </div>
            {/* User */}
            <div className="user"><a href="#"><div><img src={imgUser} /><div>1</div></div></a></div>
            {/* Cart */}
            <div className="cart"><a href="cart.html"><div><img className="svg" src="images/cart.svg" /></div></a></div>
            {/* Phone */}
